...
<html lang="en">
    <head>
        ...
        <!-- start: Meta -->
        <meta charset="utf-8">
        <title>Admin Panel Of Farming Assistants</title>
                    ...
                    <div class="nav-collapse sidebar-nav">
                        ...
                        <?php if ($this->session->userdata('access_label') == 1) { ?>
                            <li>
                                ...
                                <ul>
                                    <li><a href="<?php echo base_url(); ?>super_admin/add_category"><i class="icon-envelope"></i><span class="hidden-tablet">add_category</span></a></li>
                        ...
                        <?php if ($this->session->userdata('access_label') == 1) { ?>   
                            <li>
                                <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Manufacturer</span><span class="glyphicons-chevron-down" style="margin-left: 40px;"><i class="icon-caret-down"></i></span></a>
                                <ul>
                                    <li><a href="<?php echo base_url(); ?>super_admin/add_manufacturer"><i class="icon-envelope"></i><span class="hidden-tablet">Add manufacturer</span></a></li>
                                    <li><a href="<?php echo base_url(); ?>super_admin/manage_manufacturer"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage manufacturer </span></a></li>
                                </ul>	
                            </li>
                        <?php } ?>
                        ...
                        <?php if ($this->session->userdata('access_label') == 1 || $this->session->userdata('access_label') == 2 ) { ?>
                            <li>
                                <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Product</span><span class="glyphicons-chevron-down" style="margin-left: 75px;"><i class="icon-caret-down"></i></span></a>
                                <ul>
                                    <li><a href="<?php echo base_url(); ?>super_admin/add_product"><i class="icon-envelope"></i><span class="hidden-tablet">Add Product</span></a></li>
                                    <li><a href="<?php echo base_url(); ?>super_admin/manage_product"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Product </span></a></li>
                                </ul>	
                            </li>
                        <?php } ?>
                        ...
                        <?php if ($this->session->userdata('access_label') == 1) { ?>    
                            <li>
                                <a href="<?php echo base_url();?>Super_admin/manage_order"><i class="icon-font"></i><span class="hidden-tablet"> Manage Order</span></a>
                            </li>
                        <?php } ?>
                            ...
                            <!--<li><a href="#"><i class="icon-list-alt"></i><span class="hidden-tablet"> Charts</span></a></li>-->
