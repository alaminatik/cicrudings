            ...
            <div class="row-fluid">
                ...
                <div class="row-fluid">
                    <div class="login-box">
                        ...
                        <form class="form-horizontal" action="<?php echo base_url(); ?>userlogin" method="post">
                            <fieldset>

                                <div class="input-prepend" title="Username">
                                    <span class="add-on"><i class="halflings-icon user"></i></span>
                                    <input class="input-large span10" name="email" id="username" type="text" placeholder="type username Or Email"/>
                                </div>
                                ...
                                <!-- <div class="input-prepend" >
                                    <span class="add-on"><i class="halflings-icon user"></i></span>
                                    <select id="selectError3" class="input-large span10" name="access_label">
                        ...
                        <p>
                            No problem, <a href="<?php echo base_url();?>registration">click here</a> for registration.
                        </p>	
                    </div><!--/span-->
                </div><!--/row-->
